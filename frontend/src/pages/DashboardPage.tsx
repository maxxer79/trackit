              ...
              >
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <ItemAlertRules productId={item.product.id} productSlug={item.product.slug} alertMaxPrice={item.alertMaxPrice} priceTarget={item.priceTarget} alertDays={item.alertDays} />
